...
if (getattr(paddle.base.framework, "_in_eager_mode_", False)) or (
    hasattr(paddle.base.framework, "global_var")
    and getattr(paddle.base.framework.global_var, "_in_eager_mode_", False)
):
...
def run_custom(op_name, inputs_names, inputs_var, attrs_names, attrs_val, outputs_names, outputs_dtype=None):
    ...
    if (
        getattr(paddle.base.framework, "_in_eager_mode_", False)
        and getattr(paddle.base.framework, "_dygraph_tracer_", None) is not None
    ) or (
        hasattr(paddle.base.framework, "global_var")
        and getattr(paddle.base.framework.global_var, "_in_eager_mode_", False)
        and getattr(paddle.base.framework.global_var, "_dygraph_tracer_", None) is not None
    ):
